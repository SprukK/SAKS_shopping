  ...
  return (
    <main className={shoppingMode ? "shopping-mode" : ""}>
      <header className="top">
        ...
        >
          {shoppingMode ? "Končaj nakup" : "🛒 Začni nakup"}
        </button>
      </header>
      ...
      {tab === "people" && <People trip={trip} />}{" "}
      {tab === "activity" && me.is_admin && (
        ...
        <article className="card meal" key={m.id}>
          ...
          {!readOnly && (
            <div className="actions">
              ...
              <button onClick={() => transfer(m)}>Dodaj v nakup</button>
            </div>
          )}
        </article>
      ))}
        ...
        {shown.map((i) => (
          ...
          >
            ...
            <span>
              ...
              {i.buyer?.display_name && (
                <em>Kupil/a: {i.buyer.display_name}</em>
              )}
            </span>
          </button>
        ))}
